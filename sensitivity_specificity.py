...
# The code is more flexible than strictly needed for that task, bc I reused this some from a more involved bayesian statistics project
...
def binomial_df(num_hypotheses: int, n: int, k: int, minimum: float = 0, maximum: float = 100,
    ...
    """
    step = (maximum - minimum) / num_hypotheses  # should be - 1 in denominator
